				...
				<div class="item-search-action">
					<div class="widget_search">
						<form:form modelAttribute="search"
							action="/shop-all-item/search-name">
							<form:input path="name" type="search" class="form-control"
								placeholder="Tìm tên..." />
					...
					<div class="item-action">
							...
							<div class="dropdown-menu-acc">
								<c:choose>
									...
									<c:when test="${not empty userDis}">
										...
										<a class="dropdown-item-acc" href="/user-details"><img
											class="user-login-icon" alt="user"
						...
						<a class="d-flex giohang" href="/cart/checkout"> <span
