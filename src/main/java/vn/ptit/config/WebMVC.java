...
public class WebMVC implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/files_laptops/**").addResourceLocations("file:E:/LaptopProject/upload/Laptops/");
		registry.addResourceHandler("/files_users/**").addResourceLocations("file:E:/LaptopProject/upload/Users/");
		registry.addResourceHandler("/files_banners/**").addResourceLocations("file:E:/LaptopProject/upload/Banners/");
